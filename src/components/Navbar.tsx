    ...
    <>
      <header className="sticky top-0 z-30 flex h-14 items-center bg-white justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <img src="/fun-88.webp" alt="FUN88" className="h-6 w-auto" />
        </div>
        ...
        <div className="flex items-center gap-2">
          <button className="rounded-lg bg-[#2596be] px-3 py-1.5 text-sm font-semibold uppercase text-white hover:bg-[#1f7a9d]">
            Login
          </button>
          <button className="rounded-lg bg-green-500 px-3 py-1.5 text-sm font-semibold uppercase text-white hover:bg-green-600">
            Register
          </button>
        </div>
      </header>
